...
import MenuSorteosConfigurados from "@/components/jugarevento/MenuSorteosConfigurados";
...
export default async function JugarSorteoPage({ params }) {
  ...
  const configuracionesForm = JSON.parse(decodeURIComponent(configuraciones));
    ...
    <>
      <div className="flex flex-row overflow-hidden">
        ...
        >
          ...
          <MenuSorteosConfigurados
            id={id}
            data={sorteos}
            configuraciones={configuracionesForm}
          />
